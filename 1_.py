# finction = A block of reuseable code
    # place () after the function name to invoke it

# def happy_birthday(name, age): # define functon (peramiter)
#     print("Happy Birthday to {age}!")
#     print("You are {age} years old!")
#     print("Happy Birthday to you!")
#     print()

# happy_birthday("Bro" , 20) # call/envoke function - (argument) - real data
...
# display_invoice("MartyYa", 200.97, "02/18")
# display_invoice("CarlaOh", 67.67, "01/30")
